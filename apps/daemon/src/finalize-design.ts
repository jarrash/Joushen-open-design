...
// tsconfig does not resolve the `@joushen-studio/contracts/api/chat` subpath
...
} from '@joushen-studio/contracts/api/finalize';
...
// canonical definitions live in @joushen-studio/contracts/api/finalize
