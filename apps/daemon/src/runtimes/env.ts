...
import { mergeProxyAwareEnv, resolveSystemProxyEnv } from '@joushen-studio/platform';
...
//
// 1. Provider BYOK is separate. It is used by Joushen Studio's direct provider
...
export function spawnEnvForAgent(
  ...
  if (agentId === 'amr') {
    ...
    // Identify Joushen Studio as the host so the vela CLI tags its command +
