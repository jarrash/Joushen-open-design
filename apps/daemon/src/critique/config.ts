import { defaultCritiqueConfig, FALLBACK_POLICIES } from '@joushen-studio/contracts/critique';
import type { CritiqueConfig } from '@joushen-studio/contracts/critique';
