...
This package captures a source-backed Joushen Studio design system for a desktop AI chat workspace. It includes reusable rules, token CSS, focused review previews, preserved assets, preserved fonts, and an applied UI kit.
...
- DESIGN.md is the canonical Joushen Studio rules document.
...
Use this skill when creating Joushen Studio artifacts that should match the Cherry Studio desktop AI chat workspace.
...
description: Use this skill when creating Joushen Studio artifacts that should match the Cherry Studio desktop AI chat workspace.
user-invocable: true
---
...
This package is intended for reusable Joushen Studio work, so future agents should keep the output grounded in captured evidence, use preserved assets instead of redrawing brand marks, keep app surfaces compact, and inspect preview cards before introducing any new component pattern. Treat it as a focused product design kit, not a generic style summary.
...
function auditComponent(componentName: string): string {
  ...
  { id: 'review', label: '${componentName} review state', detail: 'Reusable review surface for future Joushen Studio projects.' },
];
