...
//
// Two contracts:
//   1. The Zod schema in @joushen-studio/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@joushen-studio/contracts';
import { validateSafe } from '@joushen-studio/plugin-runtime';
