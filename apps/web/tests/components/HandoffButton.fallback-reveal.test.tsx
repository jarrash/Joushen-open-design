...
import type { AgentInfo, HostEditorsResponse } from '@joushen-studio/contracts';
...
describe('HandoffButton zero-editors fallback', () => {
  ...
  it('copies a framework-specific CLI handoff prompt with the local project path', async () => {
    ...
    expect(screen.getByTestId('handoff-cli-item-amr').textContent).toContain('Joushen Studio AMR');
