...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Joushen Studio\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.onboardingCreateBody': 'İstediğiniz siteyi, uygulamayı, sunumu, görseli veya videoyu tanımlayın. Joushen Studio bir proje oluşturacak ve çalışmayı düzenlenebilir tutacak.',
  ...
  'settings.onboardingGateTooltipAmr': 'Sonraki adımlar yapay zekâ ile çalışır — devam etmek için Joushen Studio AMR’ye giriş yapın.',
  ...
  'settings.agentInstall.pathHint': 'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Joushen Studio daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth': 'Joushen Studio\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'Joushen Studio\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'settings.privacyHint': 'Joushen Studio ekibiyle hangi veriler paylaşılır',
  'settings.privacyConsentKicker': 'Joushen Studio\'ı geliştirmemize yardımcı olun',
  'settings.privacyConsentLead': 'Joushen Studio, geliştirmemize yardımcı olmak için kullanım verilerini ekibimizle paylaşabilir. Buna şunlar dahildir:',
  ...
  'settings.mcpHint': 'Kodlama agent\'larının (Cursor, Claude Code, VS Code…) Joushen Studio projelerinizi doğrudan okumasına izin verin.',
  'settings.mcpDaemonError': 'Kurulum yollarını çözümlemek için yerel daemon\'a ulaşılamadı ({error}). Joushen Studio\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'settings.mcpBuildDaemon': 'Önce daemon\'ı derleyin.',
  'settings.mcpNodeMissing': 'Node ikili dosyası eksik.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js eksik. `pnpm --filter @joushen-studio/daemon build` komutunu çalıştırın ve yenileyin.',
  ...
  'settings.mcpCapabilityDefault': 'Joushen Studio\'da açık olan projeyi ve dosyayı varsayılan olarak kullanın; böylece hangi tasarım olduğunu yeniden belirtmeden "bunu uygulamamda oluştur" diyebilirsiniz.',
  'settings.mcpRunningNote': 'MCP araç çağrılarının başarılı olması için Joushen Studio\'ın çalışıyor olması gerekir. Kodlama agent\'ınızı Joushen Studio\'ı açmadan önce başlattıysanız, canlı daemon\'a ulaşabilmesi için agent\'ı yeniden başlatın.',
  ...
  'entry.discordAria': 'Joushen Studio Discord\'una katılın',
  'entry.discordAriaWithOnline': 'Joushen Studio Discord\'una katılın - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Yeniden kullanılabilir bir Joushen Studio plugin\'i oluşturun ve Plugin\'lerim\'e ekleyin.',
  ...
  'handoff.promptIntro': 'Bu yerel Joushen Studio proje klasöründen devam edin:',
  ...
  'pluginsHome.subtitle': 'Bu çalışma zamanıyla birlikte gelen, kullanıma hazır Joushen Studio iş akışları. Başlangıç istemi yüklemek için birini seçin veya daha fazlası için kayıt defterine göz atın.',
  ...
  'pluginsHome.emptyCatalog': 'Katalog boş. Paketlenmiş eklentiler Joushen Studio ile birlikte gelir ve buraya otomatik olarak görünmelidir — bu durum devam ederse daemon\'u yeniden başlatmayı deneyin.',
  ...
  'pluginCard.contributeAria': '{title} öğesini Joushen Studio\'a katkı olarak ekle',
  'pluginCard.contributeTitle': 'Plugin\'i pull request ile Joushen Studio\'a katkı olarak ekle',
  ...
  'integrations.lede': 'Harici sistemleri bağlayın, MCP araçlarını agent döngünüze dahil edin ve Joushen Studio\'ı diğer IDE\'ler, betikler ve otomasyonlardan kullanın.',
  ...
  'mcpClient.daemonError': 'Yerel daemon\'a ulaşılamadı. Joushen Studio\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'mcpClient.saveFailed': 'Kaydetme başarısız oldu. Daemon\'ın çalıştığını kontrol edip tekrar deneyin.',
  'useEverywhere.modalAria': 'Joushen Studio\'ı her yerde kullanın',
  'useEverywhere.modalTitle': 'Joushen Studio\'ı her yerde kullanın',
  'useEverywhere.modalSubtitle': 'Joushen Studio\'ı herhangi bir IDE\'ye, Agent\'a veya betiğe bırakın — CLI, HTTP, MCP ve Beceriler. Her şeyi kurmak için "Bir agent için kılavuzu kopyala"yı kullanın ve Claude Code, Codex, Cursor, openclaw veya hermes\'e yapıştırın.',
  ...
  'useEverywhere.section.overview.heading': 'Joushen Studio, agent\'ınızın çalıştığı her yerde çalışır',
  'useEverywhere.section.overview.intro': 'Joushen Studio bir pencereden fazlasıdır — yerel ayrıcalıklı bir daemon (`od`) ile birlikte bir Beceriler + Tasarım Sistemleri + Atoms kayıt defteridir. Makinenizde çalışmaya başladığında, herhangi bir kod agent\'ı (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, kendi betiğiniz) dört değiştirilebilir yüzey aracılığıyla üretimleri yönetebilir, projeleri inceleyebilir ve tasarım çıktıları üretebilir.',
  'useEverywhere.section.overview.bullet1': 'CLI — başsız betikler, CI ve kabuk otomasyonu için `od <command>`.',
  'useEverywhere.section.overview.bullet2': 'MCP sunucusu — Joushen Studio\'ı bir Model Context Protocol sunucusu olarak bağlar, böylece MCP destekli herhangi bir agent becerileri listeleyebilir, senaryoları çalıştırabilir ve çıktıları okuyabilir.',
  ...
  'useEverywhere.section.overview.bullet4': 'Beceriler — PATH\'inizde zaten bulunan herhangi bir agent\'ın Joushen Studio olmadan çağırabileceği eklenebilir `SKILL.md` paketleri (Claude uyumlu).',
  ...
  'useEverywhere.section.cli.heading': 'Joushen Studio\'ı herhangi bir kabuktan yönetin',
  ...
  'useEverywhere.section.mcp.heading': 'Joushen Studio\'ı herhangi bir kodlama agent\'ına MCP sunucusu olarak sun',
  'useEverywhere.section.mcp.intro': 'Joushen Studio, MCP destekli herhangi bir istemcinin — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — Joushen Studio araçlarını (becerileri listele, önizlemeleri oluştur, medya üret, eklentileri çalıştır) manuel olarak kabuk açmadan keşfetmesini sağlayan bir Model Context Protocol sunucusu (`od mcp`) ile gelir. Daemon, her büyük istemci için `GET /api/mcp/install-info` aracılığıyla yapıştırmaya hazır bir kurulum parçacığı yayınlar.',
  ...
  'useEverywhere.section.mcp.footer': 'Joushen Studio uygulamasında, JSON\'u elle düzenlemek yerine istemciye özel bir kurulum komutu (Cursor, Claude Code, Antigravity, VS Code) kopyalamak için Ayarlar → Entegrasyonlar\'ı açın.',
  ...
  'useEverywhere.section.http.footer': 'Her istek/yanıt için saf TypeScript türleri `@joushen-studio/contracts` içinde bulunur — bir oluşturucu bağlamadan tam otomatik tamamlama için bunları betiğinize aktarın.',
  'useEverywhere.section.skills.tab': 'Skill\'ler ve başsız',
  'useEverywhere.section.skills.heading': 'Herhangi bir agent için eklenebilir Beceriler — Joushen Studio çalışmıyor olsa bile',
  'useEverywhere.section.skills.intro': 'Bir Beceri, Claude uyumlu bir `SKILL.md` (YAML ön bilgisi + gövde) içeren bir dizindir. Joushen Studio, formatı `od:` ad alanıyla (`mode`, `preview`, `design_system`, `inputs`, …) genişletir, böylece aynı çıktı hem Joushen Studio içinde hem de Claude Code, Codex, openclaw veya hermes gibi sade bir agent tarafından kullanılabilir. Keşif, projelerin kendi becerilerini geçersiz kılabilmesi için bir öncelik zincirini izler.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude uyumlu ön bilgi + Joushen Studio ekstraları)',
  ...
  'entry.githubStarAria': 'Joushen Studio’a GitHub üzerinde yıldız ver',
  ...
  'newproj.locationDefault': 'Joushen Studio projeleri',
  ...
  'socialShare.openDesignSection': 'Joushen Studio\'ı paylaş',
  'socialShare.openDesignTitle': 'GitHub\'da Joushen Studio',
  'socialShare.openDesignText': 'Joushen Studio; tasarım yapıtları oluşturmak, düzenlemek, dağıtmak ve devretmek için açık kaynaklı bir çalışma alanıdır.',
  ...
  'socialShare.projectText': 'Joushen Studio ile oluşturuldu: {title}. Dağıtılan yapıtı görüntüleyin ve depoya yıldız verin: {repo}',
  'socialShare.projectCopyText': 'Joushen Studio ile oluşturuldu: {title}\n{url}\nJoushen Studio deposu: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Joushen Studio\'dan {file} dosyasını değiştirmesini isteyin...',
  ...
  'chat.mode.design.solves': 'Joushen Studio’ın dosya üretmesini, workspace’i güncellemesini veya brief’i çok modlu deliverable’lara dönüştürmesini istediğinizde kullanın.',
  ...
  'preview.shareTextDefault': 'Joushen Studio şablonu: {title}',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Joushen Studio\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'assistant.shareToJoushenStudio': 'Joushen Studio\'a paylaş',
  'assistant.shareToJoushenStudioBusy': 'Paket hazırlanıyor…',
  ...
  'pet.tabBuiltInHint': 'Joushen Studio ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Joushen Studio ile birlikte gelir — indirme gerekmez.',
  ...
  'settings.projectLocationsDescription': 'Birden fazla Joushen Studio proje klasörü içerebilen çalışma tabanları ekleyin. Yeni projeler seçilen tabanın içinde bir klasör olarak kaydedilir.',
  ...
  'settings.customInstructionsHint': 'JoushenStudio\'ın her sohbette uyması gereken sabit talimatlar. Gerçekleri, tercihleri ve proje bağlamını bellek olarak kaydedin.',
  ...
  'settings.memoryStarterProjectDesc': 'Joushen Studio v0.5 — sohbet odaklı tasarım editörü',
  ...
  'updater.availableBody': 'Joushen Studio {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için Joushen Studio kapatılıyor.',
  ...
  'updater.quitButton': 'Joushen Studio’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak Joushen Studio kapatılamadı. Uygulamayı değiştirmeden önce Joushen Studio’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. Joushen Studio kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'Joushen Studio {version} hazır. Joushen Studio kapanıp yükleyiciyi açacak.',
  ...
  'dsManager.createBody': 'Joushen Studio\'a markanızı, ürününüzü, kodunuzu, varlıklarınızı ve tasarım referanslarınızı öğretin.',
  ...
  'settings.customInstructionsDesc': 'Joushen Studio\'ın her sohbette izlediği sabit yönergeler. Bunlar kayıtlı bellekler değildir; gerçekler, tercihler ve proje bağlamı için Bellek\'i kullanın.',
