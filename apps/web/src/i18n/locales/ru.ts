...
export const ru: Dict = {
  ...
  'chat.amrCard.switchBody': 'Переключитесь на официальный сервис моделей AMR от Joushen Studio — без настройки API-ключа. После входа, авторизации и пополнения это выполнение будет автоматически повторено.',
  ...
  'settings.onboardingCreateBody': 'Опишите сайт, приложение, презентацию, изображение или видео, которое вам нужно. Joushen Studio создаст проект и сохранит возможность редактирования работы.',
  ...
  'settings.onboardingGateTooltipAmr': 'Следующие шаги выполняются на ИИ — войдите в Joushen Studio AMR, чтобы продолжить.',
  ...
  'settings.agentInstall.pathHint': 'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Joushen Studio (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth': 'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Joushen Studio.',
  ...
  'settings.mcpServerHint': 'Откройте Joushen Studio как MCP-сервер для вашего кодинг-агента.',
  ...
  'settings.privacyHint': 'Какие данные передаются команде Joushen Studio',
  'settings.privacyConsentKicker': 'Помогите нам улучшить Joushen Studio',
  'settings.privacyConsentLead': 'Joushen Studio может передавать данные об использовании нашей команде, чтобы помочь нам стать лучше. Сюда входят:',
  ...
  'settings.mcpHint': 'Позвольте агентам для кода (Cursor, Claude Code, VS Code…) напрямую читать ваши проекты Joushen Studio.',
  'settings.mcpDaemonError': 'Не удалось подключиться к локальному демону для определения путей установки ({error}). Убедитесь, что Joushen Studio запущен, затем снова откройте эту панель.',
  'settings.mcpBuildDaemon': 'Сначала соберите демон.',
  'settings.mcpNodeMissing': 'Отсутствует исполняемый файл Node.',
  'settings.mcpBuildHint': 'Файл apps/daemon/dist/cli.js отсутствует. Выполните `pnpm --filter @joushen-studio/daemon build` и обновите.',
  ...
  'settings.mcpCapabilityDefault': 'По умолчанию использовать проект и файл, открытые в Joushen Studio, чтобы можно было сказать «собери это в моём приложении», не уточняя, о каком дизайне идёт речь.',
  'settings.mcpRunningNote': 'Для успешного выполнения вызовов инструментов MCP необходимо, чтобы Joushen Studio был запущен. Если вы запустили своего агента для кодинга до открытия Joushen Studio, перезапустите агент, чтобы он мог подключиться к работающему демону.',
  ...
  'entry.discordAria': 'Присоединиться к Discord-сообществу Joushen Studio',
  'entry.discordAriaWithOnline': 'Присоединиться к Discord-сообществу Joushen Studio — {online}',
  ...
  'homeHero.chip.createPluginHint': 'Создайте многоразовый плагин Joushen Studio и добавьте его в раздел «Мои плагины».',
  ...
  'handoff.promptIntro': 'Продолжить из этой локальной папки проекта Joushen Studio:',
  ...
  'pluginsHome.subtitle': 'Готовые рабочие процессы Joushen Studio, входящие в состав этой среды выполнения. Выберите один, чтобы загрузить стартовый запрос, или просмотрите реестр для дополнительных вариантов.',
  ...
  'pluginsHome.emptyCatalog': 'Каталог пуст. Встроенные плагины поставляются вместе с Joushen Studio и должны появляться здесь автоматически — если проблема не исчезает, попробуйте перезапустить демон.',
  ...
  'pluginCard.contributeAria': 'Внести {title} в Joushen Studio',
  'pluginCard.contributeTitle': 'Внести плагин в Joushen Studio через pull request',
  ...
  'integrations.lede': 'Подключайте внешние системы, добавляйте инструменты MCP в цикл работы вашего агента и используйте Joushen Studio из других IDE, скриптов и средств автоматизации.',
  ...
  'mcpClient.daemonError': 'Не удалось подключиться к локальному демону. Убедитесь, что Joushen Studio запущен, затем снова откройте эту панель.',
  'mcpClient.saveFailed': 'Не удалось сохранить. Убедитесь, что демон запущен, и повторите попытку.',
  'useEverywhere.modalAria': 'Используйте Joushen Studio везде',
  'useEverywhere.modalTitle': 'Используйте Joushen Studio везде',
  'useEverywhere.modalSubtitle': 'Подключайте Joushen Studio к любой IDE, агенту или скрипту — CLI, HTTP, MCP и Skills. Используйте «Copy guide for an agent» и вставьте в Claude Code, Codex, Cursor, openclaw или hermes, чтобы настроить всё.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — готовые к использованию пакеты `SKILL.md` (совместимые с Claude), которые любой агент, уже находящийся в вашем PATH, может вызвать вообще без Joushen Studio.',
  ...
  'useEverywhere.section.cli.heading': 'Управляйте Joushen Studio из любой оболочки',
  ...
  'useEverywhere.section.mcp.heading': 'Предоставьте Joushen Studio как сервер MCP любому кодовому Agent',
  'useEverywhere.section.mcp.intro': 'Joushen Studio поставляется с сервером Model Context Protocol (`od mcp`), который позволяет любому клиенту с поддержкой MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — обнаруживать инструменты Joushen Studio (получать список навыков, отображать предпросмотры, генерировать медиа, запускать плагины) без ручного вызова через shell. Демон публикует готовый к вставке фрагмент установки через `GET /api/mcp/install-info` для каждого основного клиента.',
  ...
  'useEverywhere.section.mcp.footer': 'В приложении Joushen Studio откройте Settings → Integrations, чтобы скопировать команду установки для конкретного клиента (Cursor, Claude Code, Antigravity, VS Code) вместо ручного редактирования JSON.',
  ...
  'useEverywhere.section.http.intro': 'Локальный демон предоставляет HTTP API по адресу `http://127.0.0.1:7456` (порт настраивается). Любая конечная точка, которую вызывает веб-интерфейс, доступна и для ваших скриптов. Потоковые конечные точки (ходы чата, запуски проектов) отправляют события Server-Sent Events с типами контракта из `@joushen-studio/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Чистые типы TypeScript для каждого запроса/ответа находятся в `@joushen-studio/contracts` — импортируйте их в свой скрипт для полного автодополнения без настройки генератора.',
  'useEverywhere.section.skills.tab': 'Навыки и фоновый режим',
  'useEverywhere.section.skills.heading': 'Готовые к использованию Skills для любого агента — даже без запущенного Joushen Studio',
  'useEverywhere.section.skills.intro': 'Skill — это директория с совместимым с Claude файлом `SKILL.md` (YAML-фронтматтер + тело). Joushen Studio расширяет формат пространством имён `od:` (`mode`, `preview`, `design_system`, `inputs`, …), чтобы один и тот же артефакт можно было использовать как внутри Joushen Studio, так и обычным агентом, например Claude Code, Codex, openclaw или hermes. Обнаружение следует цепочке приоритетов, поэтому проекты могут переопределять свои собственные навыки.',
  ...
  'useEverywhere.section.skills.snippet1': 'Минимальный SKILL.md (совместимый с Claude front matter + дополнения Joushen Studio)',
  ...
  'entry.githubStarAria': 'Поставить Joushen Studio звезду на GitHub',
  ...
  'newproj.locationDefault': 'Проекты Joushen Studio',
  ...
  'socialShare.openDesignSection': 'Поделиться Joushen Studio',
  'socialShare.openDesignTitle': 'Joushen Studio на GitHub',
  'socialShare.openDesignText': 'Joushen Studio — это рабочее пространство с открытым исходным кодом для создания, редактирования, развёртывания и передачи дизайн-артефактов.',
  ...
  'socialShare.projectText': 'Создано с помощью Joushen Studio: {title}. Посмотрите развёрнутый артефакт и поставьте звезду репозиторию: {repo}',
  'socialShare.projectCopyText': 'Создано с помощью Joushen Studio: {title}\n{url}\nРепозиторий Joushen Studio: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Попросите Joushen Studio изменить {file}...',
  ...
  'chat.mode.design.solves': 'Используйте его, когда Joushen Studio должен сгенерировать файлы, обновить workspace или превратить бриф в мультимодальные deliverables.',
  ...
  'preview.shareTextDefault': 'Шаблон Joushen Studio: {title}',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Joushen Studio запущен, и повторите попытку.',
  ...
  'designFiles.usefulInfoTip7': 'Нравится Joushen Studio? Поставьте звезду на GitHub.',
  ...
  'assistant.shareToJoushenStudio': 'Поделиться в Joushen Studio',
  'assistant.shareToJoushenStudioBusy': 'Готовим пакет…',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Joushen Studio — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Joushen Studio — загрузка не нужна.',
  ...
  'settings.projectLocationsDescription': 'Добавьте рабочие базы, которые могут содержать несколько папок проектов Joushen Studio. Новые проекты сохраняются как папка внутри выбранной базы.',
  ...
  'settings.customInstructionsHint': 'Постоянные инструкции, которым Joushen Studio должен следовать в каждом чате. Сохраняйте факты, предпочтения и контекст проекта в виде памяти.',
  ...
  'settings.memoryStarterProjectDesc': 'Joushen Studio v0.5 — редактор дизайна с управлением через чат',
  ...
  'updater.availableBody': 'Joushen Studio {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. Joushen Studio закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть Joushen Studio',
  'updater.quitFailedBody': 'Установщик открыт, но Joushen Studio не удалось закрыть. Закройте Joushen Studio перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. Joushen Studio закроется и откроет установщик.',
  'updater.readyVersion': 'Joushen Studio {version} готов. Joushen Studio закроется и откроет установщик.',
  ...
  'dsManager.createBody': 'Обучите Joushen Studio вашему бренду, продукту, коду, ресурсам и дизайн-референсам.',
  ...
  'settings.customInstructionsDesc': 'Фиксированные инструкции, которым Joushen Studio следует в каждом чате. Это не сохранённые воспоминания; используйте Память для фактов, предпочтений и контекста проекта.',
