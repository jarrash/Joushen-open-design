...
export const ar: Dict = {
  ...
  'chat.amrCard.switchBody': 'بدِّل إلى خدمة نماذج AMR الرسمية من Joushen Studio — لا حاجة لإعداد مفتاح API. بعد تسجيل الدخول والتفويض والشحن، ستُعاد محاولة هذه المهمة تلقائيًا.',
  ...
  'settings.onboardingCreateBody': 'صِف الموقع أو التطبيق أو العرض التقديمي أو الصورة أو الفيديو الذي تريده. سيُنشئ Joushen Studio مشروعًا ويُبقي العمل قابلاً للتحرير.',
  ...
  'settings.onboardingGateTooltipAmr': 'الخطوات التالية تعمل بالذكاء الاصطناعي — سجّل الدخول إلى Joushen Studio AMR للمتابعة.',
  ...
  'settings.agentInstall.pathHint': 'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Joushen Studio (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth': 'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Joushen Studio.',
  ...
  'settings.mcpServerHint': 'كشف Joushen Studio كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'settings.privacyHint': 'البيانات التي تتم مشاركتها مع فريق Joushen Studio',
  'settings.privacyConsentKicker': 'ساعدنا في تحسين Joushen Studio',
  'settings.privacyConsentLead': 'يمكن لـ Joushen Studio مشاركة بيانات الاستخدام مع فريقنا لمساعدتنا على التحسين. يشمل ذلك:',
  ...
  'settings.mcpHint': 'اسمح لوكلاء البرمجة (Cursor، Claude Code، VS Code…) بقراءة مشاريع Joushen Studio الخاصة بك مباشرةً.',
  'settings.mcpDaemonError': 'تعذّر الوصول إلى الـ daemon المحلي لتحديد مسارات التثبيت ({error}). تأكد من أن Joushen Studio قيد التشغيل، ثم أعد فتح هذه اللوحة.',
  'settings.mcpBuildDaemon': 'قم ببناء الـ daemon أولًا.',
  'settings.mcpNodeMissing': 'ملف Node التنفيذي مفقود.',
  'settings.mcpBuildHint': 'الملف apps/daemon/dist/cli.js مفقود. شغّل `pnpm --filter @joushen-studio/daemon build` ثم حدّث.',
  ...
  'settings.mcpCapabilityDefault': 'الاعتماد افتراضيًا على المشروع والملف المفتوحَين في Joushen Studio، حتى تتمكن من قول "ابنِ هذا في تطبيقي" دون إعادة تحديد التصميم المقصود.',
  'settings.mcpRunningNote': 'يجب أن يكون Joushen Studio قيد التشغيل حتى تنجح استدعاءات أدوات MCP. إذا بدأت تشغيل وكيل البرمجة قبل فتح Joushen Studio، فأعد تشغيل الـ Agent ليتمكن من الوصول إلى الـ daemon النشط.',
  ...
  'entry.discordAria': 'انضم إلى Discord الخاص بـ Joushen Studio',
  'entry.discordAriaWithOnline': 'انضم إلى Discord الخاص بـ Joushen Studio - {online}',
  ...
  'homeHero.chip.createPluginHint': 'أنشئ إضافة Joushen Studio قابلة لإعادة الاستخدام وأضِفها إلى إضافاتي.',
  ...
  'handoff.promptIntro': 'المتابعة من مجلد مشروع Joushen Studio المحلي هذا:',
  ...
  'pluginsHome.subtitle': 'سير عمل Joushen Studio جاهز للاستخدام ومرفق بهذا التشغيل. اختر واحدًا لتحميل موجّه بدء، أو تصفّح السجل للمزيد.',
  'pluginsHome.browseRegistry': 'تصفح السجل',
  'pluginsHome.count': '{filtered} من {total}',
  'pluginsHome.loadingCatalog': 'جارٍ تحميل الكتالوج…',
  'pluginsHome.emptyCatalog': 'الكتالوج فارغ. تأتي الإضافات المُجمَّعة مع Joushen Studio ومن المفترض أن تظهر هنا تلقائيًا — جرّب إعادة تشغيل الـ daemon إذا استمرت هذه المشكلة.',
  ...
  'pluginCard.contributeAria': 'المساهمة بـ {title} في Joushen Studio',
  'pluginCard.contributeTitle': 'المساهمة بالإضافة في Joushen Studio عبر طلب سحب (PR)',
  ...
  'integrations.lede': 'اربط الأنظمة الخارجية، وأدخِل أدوات MCP إلى حلقة الـ Agent الخاصة بك، واستخدم Joushen Studio من بيئات تطوير وبرامج نصية وعمليات أتمتة أخرى.',
  ...
  'mcpClient.daemonError': 'تعذّر الوصول إلى الخدمة المحلية. تأكّد من أن Joushen Studio قيد التشغيل، ثم أعِد فتح هذه اللوحة.',
  'mcpClient.saveFailed': 'فشل الحفظ. تحقّق من أن الخدمة قيد التشغيل وحاول مرة أخرى.',
  'useEverywhere.modalAria': 'استخدم Joushen Studio في كل مكان',
  'useEverywhere.modalTitle': 'استخدم Joushen Studio في كل مكان',
  'useEverywhere.modalSubtitle': 'أدرِج Joushen Studio في أي IDE أو Agent أو سكربت — CLI وHTTP وMCP وSkills. استخدم “Copy guide for an agent” والصقه في Claude Code أو Codex أو Cursor أو openclaw أو hermes لإعداد كل شيء.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — حزم `SKILL.md` جاهزة للاستخدام (متوافقة مع Claude) يمكن لأي Agent موجود مسبقًا على الـ PATH استدعاؤها دون الحاجة إلى Joushen Studio على الإطلاق.',
  ...
  'useEverywhere.section.cli.heading': 'تشغيل Joushen Studio من أي shell',
  ...
  'useEverywhere.section.mcp.heading': 'اجعل Joushen Studio متاحًا كخادم MCP لأي coding agent',
  'useEverywhere.section.mcp.intro': 'يأتي Joushen Studio مع خادم Model Context Protocol (`od mcp`) يتيح لأي عميل يدعم MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اكتشاف أدوات Joushen Studio (سرد المهارات، عرض المعاينات، توليد الوسائط، تشغيل الإضافات) دون استخدام الـ shell يدويًا. ينشر الـ daemon مقتطف تثبيت جاهزًا للصق عبر `GET /api/mcp/install-info` لكل عميل رئيسي.',
  ...
  'useEverywhere.section.mcp.footer': 'في تطبيق Joushen Studio، افتح الإعدادات → التكاملات لنسخ أمر تثبيت خاص بكل عميل (Cursor، Claude Code، Antigravity، VS Code) بدلًا من تحرير JSON يدويًا.',
  ...
  'useEverywhere.section.http.footer': 'تتوفر أنواع TypeScript خالصة لكل طلب/استجابة في `@joushen-studio/contracts` — استوردها في سكربتك للحصول على إكمال تلقائي كامل دون تهيئة مُولِّد.',
  'useEverywhere.section.skills.tab': 'المهارات والوضع بدون واجهة',
  'useEverywhere.section.skills.heading': 'مهارات Skills جاهزة للاستخدام لأي Agent — حتى دون تشغيل Joushen Studio',
  'useEverywhere.section.skills.intro': 'المهارة هي دليل يحتوي على `SKILL.md` متوافق مع Claude (مقدّمة YAML + متن). يوسّع Joushen Studio التنسيق بفضاء الأسماء `od:` (`mode`، `preview`، `design_system`، `inputs`، …) بحيث يمكن استخدام المخرَج نفسه داخل Joushen Studio ومن قِبل Agent عادي مثل Claude Code أو Codex أو openclaw أو hermes. يتّبع الاكتشاف سلسلة أولوية بحيث يمكن للمشاريع تجاوز مهاراتها الخاصة.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md بحدّه الأدنى (front matter متوافق مع Claude + إضافات Joushen Studio)',
  ...
  'entry.githubStarAria': 'منح Joushen Studio نجمة على GitHub',
  ...
  'newproj.locationDefault': 'مشاريع Joushen Studio',
  ...
  'socialShare.openDesignSection': 'مشاركة Joushen Studio',
  'socialShare.openDesignTitle': 'Joushen Studio على GitHub',
  'socialShare.openDesignText': 'Joushen Studio هي مساحة عمل مفتوحة المصدر لإنشاء عناصر التصميم وتحريرها ونشرها وتسليمها.',
  ...
  'socialShare.projectText': 'تم الإنشاء باستخدام Joushen Studio: {title}. اعرض العنصر المنشور وامنح نجمة للمستودع: {repo}',
  'socialShare.projectCopyText': 'تم الإنشاء باستخدام Joushen Studio: {title}\n{url}\nمستودع Joushen Studio: {repo}',
  ...
  'chat.activeFilePlaceholder': 'اطلب من Joushen Studio تعديل {file}...',
  ...
  'chat.mode.design.solves': 'استخدمه عندما تريد من Joushen Studio إنشاء ملفات، تحديث مساحة العمل، أو تحويل موجز إلى مخرجات متعددة الوسائط جاهزة.',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Joushen Studio ثم أعد المحاولة.',
  ...
  'designFiles.usefulInfoTip7': 'أعجبك Joushen Studio؟ امنحنا نجمة على GitHub.',
  ...
  'assistant.shareToJoushenStudio': 'المشاركة على Joushen Studio',
  'assistant.shareToJoushenStudioBusy': 'جارٍ تجهيز الحزمة…',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع Joushen Studio - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع Joushen Studio - لا حاجة للتحميل.',
  ...
  'settings.projectLocationsDescription': 'أضف قواعد عمل يمكن أن تحتوي على عدة مجلدات مشاريع Joushen Studio. تُحفظ المشاريع الجديدة كمجلد داخل القاعدة المحددة.',
  ...
  'settings.customInstructionsHint': 'تعليمات ثابتة يجب أن يتبعها JoushenStudio في كل محادثة. احفظ الحقائق والتفضيلات وسياق المشروع كذكريات.',
  ...
  'settings.memoryStarterProjectDesc': 'Joushen Studio v0.5 — محرر تصميم يعمل بالمحادثة',
  ...
  'updater.availableBody': 'Joushen Studio {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء Joushen Studio لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء Joushen Studio',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء Joushen Studio. أغلق Joushen Studio قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق Joushen Studio وفتح المثبت.',
  'updater.readyVersion': 'Joushen Studio {version} جاهز. سيتم إغلاق Joushen Studio وفتح المثبت.',
  ...
  'dsManager.createBody': 'علّم Joushen Studio علامتك التجارية ومنتجك وكودك وأصولك ومراجع التصميم الخاصة بك.',
  ...
  'settings.customInstructionsDesc': 'تعليمات ثابتة يتبعها Joushen Studio في كل محادثة. هذه ليست ذكريات محفوظة؛ استخدم الذاكرة للحقائق والتفضيلات وسياق المشروع.',
