...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di Joushen Studio — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.onboardingCreateBody': 'Descrivi il sito, l\'app, la presentazione, l\'immagine o il video che desideri. Joushen Studio creerà un progetto e manterrà il lavoro modificabile.',
  ...
  'settings.onboardingGateTooltipAmr': 'I passaggi successivi vengono eseguiti tramite IA — accedi a Joushen Studio AMR per continuare.',
  ...
  'settings.agentInstall.pathHint': 'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Joushen Studio (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth': 'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Joushen Studio.',
  ...
  'settings.mcpServerHint': 'Esponi Joushen Studio come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Joushen Studio',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Joushen Studio',
  'settings.privacyConsentLead': 'Joushen Studio può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'settings.mcpHint': 'Consenti agli agent di coding (Cursor, Claude Code, VS Code…) di leggere direttamente i tuoi progetti Joushen Studio.',
  'settings.mcpDaemonError': 'Impossibile raggiungere il daemon locale per risolvere i percorsi di installazione ({error}). Assicurati che Joushen Studio sia in esecuzione, quindi riapri questo pannello.',
  'settings.mcpBuildDaemon': 'Compila prima il daemon.',
  'settings.mcpNodeMissing': 'Il binario Node è mancante.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js è mancante. Esegui `pnpm --filter @joushen-studio/daemon build` e aggiorna.',
  ...
  'settings.mcpCapabilityDefault': 'Utilizzare per impostazione predefinita il progetto e il file che hai aperto in Joushen Studio, così puoi dire "build this in my app" senza dover ripetere quale design.',
  'settings.mcpRunningNote': 'Joushen Studio deve essere in esecuzione affinché le chiamate agli strumenti MCP abbiano successo. Se hai avviato il tuo coding agent prima di aprire Joushen Studio, riavvia l\'agent in modo che possa raggiungere il daemon attivo.',
  ...
  'entry.discordAria': 'Unisciti al Discord di Joushen Studio',
  'entry.discordAriaWithOnline': 'Unisciti al Discord di Joushen Studio - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Crea un plugin Joushen Studio riutilizzabile e aggiungilo a I miei plugin.',
  ...
  'handoff.promptIntro': 'Continua da questa cartella di progetto locale di Joushen Studio:',
  ...
  'pluginsHome.subtitle': 'Workflow di Joushen Studio pronti all\'uso inclusi in questo runtime. Scegline uno per caricare un prompt iniziale oppure esplora il registry per altro.',
  ...
  'pluginsHome.emptyCatalog': 'Il catalogo è vuoto. I plugin inclusi sono forniti con Joushen Studio e dovrebbero comparire qui automaticamente — prova a riavviare il daemon se il problema persiste.',
  ...
  'pluginCard.contributeAria': 'Contribuisci con {title} a Joushen Studio',
  'pluginCard.contributeTitle': 'Contribuisci con il plugin a Joushen Studio tramite una pull request',
  ...
  'integrations.lede': 'Collega sistemi esterni, porta gli strumenti MCP nel loop del tuo agent e usa Joushen Studio da altri IDE, script e automazioni.',
  ...
  'mcpClient.daemonError': 'Impossibile raggiungere il daemon locale. Assicurati che Joushen Studio sia in esecuzione, quindi riapri questo pannello.',
  'mcpClient.saveFailed': 'Salvataggio non riuscito. Verifica che il daemon sia in esecuzione e riprova.',
  'useEverywhere.modalAria': 'Usa Joushen Studio ovunque',
  'useEverywhere.modalTitle': 'Usa Joushen Studio ovunque',
  'useEverywhere.modalSubtitle': 'Integra Joushen Studio in qualsiasi IDE, agent o script — CLI, HTTP, MCP e Skill. Usa “Copia la guida per un agent” e incollala in Claude Code, Codex, Cursor, openclaw o hermes per configurare tutto.',
  ...
  'useEverywhere.section.overview.heading': 'Joushen Studio funziona ovunque lavori il tuo agent',
  'useEverywhere.section.overview.intro': 'Joushen Studio è molto più di una finestra — è un daemon locale con privilegi (`od`) più un registro di Skill + Design System + Atoms. Una volta in esecuzione sulla tua macchina, qualsiasi agent di codice (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, un tuo script) può avviare generazioni, ispezionare progetti e produrre artefatti di design attraverso quattro interfacce intercambiabili.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` per script headless, CI e automazione da shell.',
  'useEverywhere.section.overview.bullet2': 'Server MCP — collega Joushen Studio come server Model Context Protocol così che qualsiasi agent compatibile con MCP possa elencare skill, eseguire scenari e leggere artefatti.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skill — pacchetti `SKILL.md` pronti all\'uso (compatibili con Claude) che qualsiasi agent già presente nel tuo PATH può invocare senza Joushen Studio.',
  ...
  'useEverywhere.section.cli.heading': 'Controlla Joushen Studio da qualsiasi shell',
  ...
  'useEverywhere.section.mcp.heading': 'Esponi Joushen Studio come server MCP a qualsiasi coding agent',
  'useEverywhere.section.mcp.intro': 'Joushen Studio include un server Model Context Protocol (`od mcp`) che consente a qualsiasi client compatibile con MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — di scoprire gli strumenti di Joushen Studio (elenca skill, genera anteprime, genera media, esegui plugin) senza ricorrere manualmente alla shell. Il daemon pubblica uno snippet di installazione pronto da incollare tramite `GET /api/mcp/install-info` per ogni client principale.',
  ...
  'useEverywhere.section.http.footer': 'I tipi TypeScript puri per ogni richiesta/risposta si trovano in `@joushen-studio/contracts` — importali nel tuo script per il completamento automatico completo senza configurare un generatore.',
  'useEverywhere.section.skills.tab': 'Skill e headless',
  'useEverywhere.section.skills.heading': 'Skill pronte all\'uso per qualsiasi agent — anche senza Joushen Studio in esecuzione',
  'useEverywhere.section.skills.intro': 'Una Skill è una directory con un file `SKILL.md` compatibile con Claude (front-matter YAML + corpo). Joushen Studio estende il formato con il namespace `od:` (`mode`, `preview`, `design_system`, `inputs`, …) così che lo stesso artefatto possa essere usato sia all\'interno di Joushen Studio sia da un agent standard come Claude Code, Codex, openclaw o hermes. Il rilevamento segue una catena di precedenza così che i progetti possano sovrascrivere le proprie skill.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimale (front matter compatibile con Claude + extra di Joushen Studio)',
  ...
  'entry.githubStarAria': 'Assegna una star a Joushen Studio su GitHub',
  ...
  'newproj.locationDefault': 'Progetti Joushen Studio',
  ...
  'socialShare.openDesignSection': 'Condividi Joushen Studio',
  'socialShare.openDesignTitle': 'Joushen Studio su GitHub',
  'socialShare.openDesignText': 'Joushen Studio è uno spazio di lavoro open-source per creare, modificare, distribuire e consegnare artifact di design.',
  ...
  'socialShare.projectText': 'Creato con Joushen Studio: {title}. Visualizza l\'artifact distribuito e metti una stella al repo: {repo}',
  'socialShare.projectCopyText': 'Creato con Joushen Studio: {title}\n{url}\nRepo di Joushen Studio: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Chiedi a Joushen Studio di modificare {file}...',
  ...
  'chat.mode.design.solves': 'Usala quando vuoi che Joushen Studio generi file, aggiorni il workspace o trasformi un brief in deliverable multimodali.',
  ...
  'preview.shareTextDefault': 'Template Joushen Studio: {title}',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Joushen Studio sia in esecuzione e riprova.',
  ...
  'designFiles.usefulInfoTip7': 'Ti piace Joushen Studio? Lascia una stella su GitHub.',
  ...
  'assistant.shareToJoushenStudio': 'Condividi su Joushen Studio',
  'assistant.shareToJoushenStudioBusy': 'Preparazione pacchetto…',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Joushen Studio — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Joushen Studio — nessun download necessario.',
  ...
  'settings.projectLocationsDescription': 'Aggiungi basi di lavoro che possono contenere più cartelle di progetti Joushen Studio. I nuovi progetti vengono salvati come una cartella nella base selezionata.',
  ...
  'settings.customInstructionsHint': 'Istruzioni fisse che JoushenStudio deve seguire in ogni chat. Salva fatti, preferenze e contesto del progetto come memorie.',
  ...
  'settings.memoryStarterProjectDesc': 'Joushen Studio v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'Joushen Studio {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. Joushen Studio si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.quitButton': 'Esci da Joushen Studio',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma Joushen Studio non è riuscito a uscire. Esci da Joushen Studio prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. Joushen Studio si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'Joushen Studio {version} è pronto. Joushen Studio si chiuderà e aprirà il programma di installazione.',
  ...
  'dsManager.createBody': 'Insegna a Joushen Studio il tuo brand, prodotto, codice, asset e riferimenti di design.',
  ...
  'settings.customInstructionsDesc': 'Istruzioni fisse che Joushen Studio segue in ogni chat. Non sono memorie salvate; usa Memoria per fatti, preferenze e contesto del progetto.',
