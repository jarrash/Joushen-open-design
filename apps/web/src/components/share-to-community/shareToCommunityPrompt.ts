// Trigger prompt for the post-completion "Share to Joushen Studio" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as a Joushen Studio plugin so I can install it into My plugins and open a PR to the Joushen Studio community catalog.',
  '',
