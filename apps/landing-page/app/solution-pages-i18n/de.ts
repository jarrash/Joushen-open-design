...
export const DE: SolutionLocaleCopy = {
  prototype: {
    title: 'Interaktive Prototypen mit Joushen Studio + Claude Code bauen',
    description:
      'Verwandle einen Prompt in einen klickbaren Multi-Screen-Prototypen, ohne dein Terminal zu verlassen. Joushen Studio gibt deinem Coding-Agent die Design-Fähigkeiten, Vorlagen und das Designsystem, um echte Prototypen auszuliefern, die du im Browser öffnen kannst.',
    breadcrumb: 'Prototyp',
    ...
    tldrBody:
      'Joushen Studio ist die Design-Ebene für den Coding-Agent, den du bereits nutzt. Fürs Prototyping heißt das: von einer Idee in einem Absatz zu einem navigierbaren, gestalteten Prototypen in einer einzigen Session — kein Design-Tool, kein Export-Schritt, keine Übergabelücke.',
    stepsTitle: 'So funktioniert Prototyping mit Joushen Studio',
    steps: [
      {
        title: 'Beschreibe den Flow',
        body: 'Sag deinem Agent in klarer Sprache, was du baust — "ein Onboarding-Flow mit Willkommens-Screen, Tarifauswahl und Bestätigung." Joushen Studio lädt die Prototyp-Fähigkeit, damit der Agent weiß, dass er Screens produzieren soll, nicht eine einzelne Seite.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Der Agent wendet ein Designsystem und Prototyp-Vorlagen von Joushen Studio an, sodass jeder Screen Typografie, Abstände und Komponenten teilt, statt wie ein grober Entwurf auszusehen. Du bekommst ein zusammenhängendes Set von Screens, keine zusammenhanglosen Mockups.',
        imageAlt:
    ...
    tableTitle: 'Prototyping mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Prototypen, die Menschen mit Joushen Studio gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        q: 'Brauche ich ein Design-Tool wie Figma, um mit Joushen Studio zu prototypisieren?',
        a: 'Nein. Joushen Studio läuft in deinem Coding-Agent und rendert Prototypen als HTML. Du beschreibst den Flow in Sprache; der Agent produziert die Screens. Es gibt kein separates Canvas-Tool zu lernen oder zu bezahlen.',
      },
      {
      ...
      },
      {
        ...
        a: 'Joushen Studio funktioniert mit Claude Code, Codex, Cursor Agent, Gemini CLI und einem Dutzend weiterer hauseigener Adapter. Du bringst deine eigenen Anbieter-Schlüssel mit; nichts wird für dich gehostet.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle dein nächstes "Was wäre wenn" in etwas Klickbares — im Agent, den du bereits nutzt.',
  },
  dashboard: {
    title: 'Daten-Dashboards mit Joushen Studio + Claude Code erstellen',
    description:
    ...
    lead: 'Sag deinem Agent, was er zeigen soll und wie es wirken soll. Joushen Studio liefert die Diagrammmuster, das Layoutsystem und die visuelle Sprache, sodass du ein zusammenhängendes, vorzeigbares Dashboard bekommst — keine Wand aus Widgets im Standardstil.',
    heroImageAlt:
      'Redaktionelle Illustration: rohe Zahlen links fließen in ein sauberes Dashboard aus Diagrammen und KPI-Karten rechts',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio verwandelt eine in klarer Sprache verfasste Spezifikation deiner Kennzahlen in ein gestaltetes Dashboard, das dein Agent als HTML rendert — versioniert in deinem Repo, überall hostbar, ohne BI-Abo pro Platz.',
    stepsTitle: 'So funktionieren Dashboards mit Joushen Studio',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Joushen Studio liefert Diagramm- und Layout-Vorlagen, sodass Trends zu Liniendiagrammen, Aufschlüsselungen zu Balken und Verhältnisse zur richtigen Visualisierung werden — durchgängig einheitliche Typografie und Abstände statt nicht zusammenpassender Standards.',
    ...
    tableTitle: 'Dashboards mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Dashboards, die Menschen mit Joushen Studio gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. Joushen Studio rendert Dashboards als HTML in deinem Coding-Agent. Du beschreibst die Kennzahlen und richtest es auf deine Daten; es gibt keine separate BI-Plattform zu lizenzieren oder zu lernen.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle deine Kennzahlen in ein Dashboard, das du überall hosten kannst — im Agent, den du bereits nutzt.',
  },
  slides: {
    title: 'Präsentations-Decks mit Joushen Studio + Claude Code erstellen',
    description:
      'Verwandle eine Gliederung in ein gestaltetes, markengerechtes Slide-Deck, ohne eine Präsentations-App zu öffnen. Joushen Studio gibt deinem Coding-Agent Deck-Vorlagen und ein visuelles System und rendert Slides als HTML, das du präsentieren, exportieren oder teilen kannst.',
    breadcrumb: 'Slides',
    label: 'Anwendungsfall · Slides',
    heading: 'Decks, die gestaltet aussehen, von einem Prompt geschrieben',
    lead: 'Gib deinem Agent eine Gliederung und einen Ton. Joushen Studio wendet eine Deck-Vorlage und ein visuelles System an, sodass jede Slide angeordnet, gesetzt und markengerecht ist — keine Aufzählung auf leerem Hintergrund.',
    heroImageAlt:
      'Redaktionelle Illustration: eine Gliederung links verwandelt sich in eine Folge gestalteter Präsentations-Slides rechts',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio verwandelt eine Gliederung in ein gestaltetes HTML-Deck, das dein Agent in einer Session rendert — präsentiere es im Browser, exportiere nach PDF oder PPTX und behalte die Quelle in deinem Repo.',
    stepsTitle: 'So funktionieren Decks mit Joushen Studio',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Joushen Studio liefert Deck-Vorlagen — redaktionell, Swiss-International, dunkel-technisch und mehr. Der Agent wendet eine an, sodass Typografie, Raster und Akzente über jede Slide hinweg einheitlich bleiben.',
    ...
    tableTitle: 'Decks mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Decks, die Menschen mit Joushen Studio gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. Joushen Studio rendert Decks als HTML in deinem Coding-Agent und kann nach PDF oder PPTX exportieren. Du präsentierst aus dem Browser oder übergibst eine Datei — keine Präsentations-App nötig, um es zu bauen.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle deine Gliederung in ein gestaltetes Deck — im Agent, den du bereits nutzt.',
  },
  image: {
    title: 'Markengerechte Grafiken mit Joushen Studio + Claude Code erstellen',
    description:
    ...
    lead: 'Beschreibe die Card oder das Cover, das du brauchst. Joushen Studio komponiert es mit echter Schrift, Raster und deinen Markenfarben — und rendert dann zu HTML, das du als Bild exportierst, statt mit einer Design-App oder einer generischen Vorlage zu ringen.',
    heroImageAlt:
      'Redaktionelle Illustration: ein Prompt verwandelt sich in ein Set angeordneter Social-Cards und Artikel-Cover',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio verwandelt einen Prompt in eine gesetzte, markengerechte Grafik, die dein Agent als HTML rendert und nach PNG exportiert — wiederholbar, versioniert und frei von Design-Tools pro Platz.',
    stepsTitle: 'So funktionieren Grafiken mit Joushen Studio',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Joushen Studio zieht deine Farben, Schrift und Abstände aus einem wiederverwendbaren Designsystem, sodass jede Card zum Rest deiner Marke passt, statt wie ein Einzelstück auszusehen.',
    ...
    tableTitle: 'Grafiken mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Grafiken, die Menschen mit Joushen Studio gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. Joushen Studio komponiert Grafiken mit echtem Layout und echter Typografie — deine Schlagzeile, deine Marke, exakte Maße — und rendert zu HTML, das du als PNG exportierst. Es ist Design-Komposition, keine Pixel-Generierung.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle einen Prompt in eine markengerechte Grafik — im Agent, den du bereits nutzt.',
  },
  video: {
    title: 'Motion-Grafiken & Kurzvideos mit Joushen Studio + Claude Code erstellen',
    description:
    ...
    lead: 'Beschreibe den Moment, den du willst — ein Titel-Reveal, eine Daten-Animation, ein Logo-Outro. Joushen Studio komponiert animierte Frames mit deinem Markensystem und rendert sie zu Video, keine Motion-Graphics-Suite nötig.',
    heroImageAlt:
      'Redaktionelle Illustration: ein Skript verwandelt sich in eine Folge animierter Video-Frames',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio verwandelt ein Skript in animierte, markengerechte Frames, die dein Agent zu Kurzvideo rendert — aus HTML komponiert, in deinem Repo versioniert, ohne Timeline-Editor zu lernen.',
    stepsTitle: 'So funktioniert Motion mit Joushen Studio',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Joushen Studio liefert Frame-Vorlagen — filmische Light-Leaks, Glitch-Titel, Logo-Outros — und wendet deine Farben und Schrift an, sodass die Bewegung gewollt und markengerecht wirkt.',
    ...
    tableTitle: 'Motion mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Motion, die Menschen mit Joushen Studio gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. Joushen Studio komponiert animierte Frames in HTML und rendert sie zu Video in deinem Coding-Agent. Es gibt keinen Timeline-Editor zu lernen oder zu lizenzieren.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle ein Skript in Motion — im Agent, den du bereits nutzt.',
  },
  designSystem: {
    title: 'Ein Designsystem mit Joushen Studio + Claude Code bauen und anwenden',
    description:
    ...
    lead: 'Definiere deine Marke einmal, und Joushen Studio trägt sie in jede Ausgabe — Prototypen, Decks, Dashboards, Grafiken. Das System liegt in deinem Repo als DESIGN.md, die der Agent liest, sodass Konsistenz automatisch entsteht, nicht von Hand.',
    heroImageAlt:
      'Redaktionelle Illustration eines einzelnen Designsystems, das in viele markengerechte Artefakte ausstrahlt',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio erfasst deine Marke als portables Designsystem, das dein Agent auf jedes Artefakt anwendet — einmal in deinem Repo definiert, überall durchgesetzt, ohne zentrales Design-Tool, das den Zugang kontrolliert.',
    stepsTitle: 'So funktionieren Designsysteme mit Joushen Studio',
    steps: [
      {
        title: 'Erfasse das System',
        body: 'Beschreibe deine Marke — Farben, Schrift, Abstände, Stimme — oder richte den Agent auf eine bestehende Website, um sie zu extrahieren. Joushen Studio schreibt sie in eine DESIGN.md, die in deinem Projekt liegt.',
      ...
      },
      {
        ...
        body: 'Joushen Studio liefert über 140 Referenz-Designsysteme — von Apple und Linear bis redaktionell und brutalistisch. Forke eines nahe deiner Marke, statt von einer leeren Seite zu starten.',
    ...
    tableTitle: 'Designsysteme mit Joushen Studio vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Designsysteme in Joushen Studio',
    galleryLead:
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Nein. Joushen Studio liefert über 140 Referenz-Designsysteme, die du forken kannst — von Apple und Linear bis redaktionell und brutalistisch — und dann an deine Marke anpasst.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und gib deinem Agent eine Marke, die er überall anwendet — im Agent, den du bereits nutzt.',
  },
  roleSoloBuilder: {
    title: 'Joushen Studio für Solo-Builder und Indie-Hacker',
    description:
      'Liefere wie ein Ein-Personen-Team. Joushen Studio macht aus deinem Coding-Agenten die Design-Hälfte deines Start-ups – Prototypen, Landingpages, Dashboards und Brand-Visuals, alles aus einem Prompt, alles markenkonform, alles in deinem Repo.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio ist die Designabteilung, die ein Solo-Gründer nie hatte: vom Prompt zum Artefakt über jede Fläche, die dein Produkt braucht, in einer Marke, ohne Übergabe und ohne zusätzliche Tools.',
    stepsTitle: 'So nutzt ein Solo-Builder Joushen Studio',
    steps: [
      {
    ...
    tableTitle: 'Solo bauen mit Joushen Studio vs. den harten Weg gehen',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Solo gebaut mit Joushen Studio',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und lass einen Agenten dein Design-Team sein – in dem Agenten, den du ohnehin nutzt.',
  },
  roleDesigner: {
    title: 'Joushen Studio für Designer',
    description:
      'Verbring deine Zeit mit Geschmack, nicht mit Fleißarbeit. Joushen Studio lässt deinen Agenten die repetitive Produktionsarbeit erledigen – Varianten, Zustände, ganze Designsysteme – während du den Look führst und das letzte Wort behältst.',
    breadcrumb: 'Designer',
    label: 'Für · Designer',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio ist die Produktionsassistenz, die nie ermüdet: Du definierst das Designsystem und bringst den Geschmack ein; der Agent erzeugt den Rest, systemkonform, in deinem Repo.',
    stepsTitle: 'So nutzt ein Designer Joushen Studio',
    steps: [
      {
    ...
    tableTitle: 'Gestalten mit Joushen Studio vs. der manuelle Weg',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Geführt mit Joushen Studio',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und lass den Agenten die Produktion erledigen, während du den Geschmack bestimmst – in dem Agenten, den du ohnehin nutzt.',
  },
  roleEngineering: {
    title: 'Joushen Studio für Engineers',
    description:
      'Überspring die Design-Übergabe. Joushen Studio verwandelt eine DESIGN.md in echtes Frontend, das dein Coding-Agent direkt schreibt – systemkonforme UI, Prototypen und Dashboards, im Repo, ohne Figma-Hin-und-Her.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio schließt die Lücke zwischen Designer und Engineer, indem es das Designsystem maschinenlesbar macht: Derselbe Agent, der deinen Code schreibt, wendet das System an und rendert echte UI.',
    stepsTitle: 'So nutzt ein Engineer Joushen Studio',
    steps: [
      {
    ...
    tableTitle: 'Frontend mit Joushen Studio vs. der Übergabeweg',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Von Engineers gebaut mit Joushen Studio',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle eine DESIGN.md in Frontend – in dem Agenten, den du ohnehin nutzt.',
  },
  roleProductManagers: {
    title: 'Joushen Studio für Produktmanager',
    description:
      'Warte nicht länger auf Design-Kapazität, um eine Idee zu vermitteln. Joushen Studio lässt einen PM aus einem Prompt einen klickbaren Prototyp oder Wireframe machen – um Stakeholder auszurichten und das Team zu briefen, ohne Design-Ticket.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio gibt einem PM einen designfreien Weg, Ideen greifbar zu machen: vom Prompt zum Prototyp für Ausrichtung und Briefings, ohne das Design-Budget des Teams zu verbrauchen.',
    stepsTitle: 'So nutzt ein PM Joushen Studio',
    steps: [
      {
        title: 'Beschreibe den Flow',
    ...
    tableTitle: 'PM-Arbeit mit Joushen Studio vs. Warten aufs Design',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    ...
    galleryTitle: 'Von PMs prototypisiert mit Joushen Studio',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle deine nächste Spec in etwas, das Leute anklicken können – in dem Agenten, den du ohnehin nutzt.',
  },
  roleMarketing: {
    title: 'Joushen Studio für Marketing-Teams',
    description:
      'Liefere Kampagnen im Content-Tempo. Joushen Studio lässt deinen Agenten Landingpages, Social-Cards und Kampagnen-Visuals aus einem Prompt erzeugen – markenkonform, auf Abruf, ohne sich beim Design anzustellen.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Joushen Studio ist die Always-on-Design-Ressource fürs Marketing: vom Prompt zum Asset für Landingpages und Social, markenkonform, sodass Kampagnen im Tempo deines Textens ausgeliefert werden.',
    stepsTitle: 'So nutzt ein Marketing-Team Joushen Studio',
    steps: [
      {
    ...
    tableTitle: 'Marketing mit Joushen Studio vs. das übliche Gewusel',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit Joushen Studio',
    tableColWithout: 'Heute ohne',
    tableRows: [
    ...
    galleryTitle: 'Vom Marketing ausgeliefert mit Joushen Studio',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere Joushen Studio und verwandle Briefings in markenkonforme Assets – in dem Agenten, den du ohnehin nutzt.',
  },
};
