...
export const TR: SolutionLocaleCopy = {
  prototype: {
    title: 'Joushen Studio + Claude Code ile etkileşimli prototipler oluşturun',
    description:
      'Bir komutu, terminalden çıkmadan tıklanabilir, çok ekranlı bir prototipe dönüştürün. Joushen Studio, kodlama ajanınıza tasarım becerilerini, şablonları ve tasarım sistemini vererek tarayıcıda açabileceğiniz gerçek prototipler üretmesini sağlar.',
    breadcrumb: 'Prototip',
    ...
    tldrBody:
      'Joushen Studio, zaten kullandığınız kodlama ajanının tasarım katmanıdır. Prototipleme için bu, tek bir paragraflık bir fikirden tek bir oturumda gezilebilir, stillendirilmiş bir prototipe geçmek demektir — tasarım aracı yok, dışa aktarma adımı yok, teslim boşluğu yok.',
    stepsTitle: 'Joushen Studio ile prototipleme nasıl çalışır',
    steps: [
      {
        title: 'Akışı tarif edin',
        body: 'Ajanınıza ne kurduğunuzu sade bir dille anlatın — “bir karşılama ekranı, bir plan seçici ve bir onay ekranı içeren bir katılım akışı.” Joushen Studio prototip becerisini yükler, böylece ajan tek bir sayfa değil ekranlar üretmesi gerektiğini bilir.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Ajan, Joushen Studio’dan bir tasarım sistemi ve prototip şablonları uygular, böylece her ekran taslak gibi görünmek yerine tipografiyi, boşlukları ve bileşenleri paylaşır. Kopuk maketler değil, tutarlı bir ekran kümesi elde edersiniz.',
        imageAlt:
    ...
    tableTitle: 'Joushen Studio ile prototipleme, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'İnsanların Joushen Studio ile oluşturduğu prototipler',
    galleryLead:
    ...
    faq: [
      {
        q: 'Joushen Studio ile prototip yapmak için Figma gibi bir tasarım aracına ihtiyacım var mı?',
        a: 'Hayır. Joushen Studio kodlama ajanınızın içinde çalışır ve prototipleri HTML olarak işler. Akışı dille tarif edersiniz; ajan ekranları üretir. Öğrenilecek ya da ücreti ödenecek ayrı bir tuval aracı yoktur.',
      },
      {
      ...
      },
      {
        ...
        a: 'Joushen Studio; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzineden fazla birinci taraf bağdaştırıcıyla çalışır. Kendi sağlayıcı anahtarlarınızı getirirsiniz; hiçbir şey sizin için barındırılmaz.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve bir sonraki “ya şöyle olsaydı”yı tıklayabileceğiniz bir şeye dönüştürün — zaten kullandığınız ajanda.',
  },
  dashboard: {
    title: 'Joushen Studio + Claude Code ile veri panoları oluşturun',
    description:
    ...
    lead: 'Ajanınıza neyi göstereceğini ve nasıl hissettirmesi gerektiğini söyleyin. Joushen Studio grafik desenlerini, düzen sistemini ve görsel dili sağlar, böylece varsayılan stilli bir bileşen yığını değil, tutarlı ve sunulabilir bir pano elde edersiniz.',
    heroImageAlt:
      'Soldaki ham sayıların sağda temiz bir grafik ve KPI kartı panosuna aktığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, metriklerinizin sade dildeki bir tanımını ajanınızın HTML olarak işlediği stillendirilmiş bir panoya dönüştürür — deponuzda sürümlenir, her yere barındırılabilir, koltuk başı BI aboneliği olmadan.',
    stepsTitle: 'Joushen Studio ile panolar nasıl çalışır',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Joushen Studio grafik ve düzen şablonları sunar, böylece trendler çizgi grafiğe, dökümler çubuklara ve oranlar doğru görsele dönüşür — uyumsuz varsayılanlar yerine baştan sona tutarlı tipografi ve boşluk.',
    ...
    tableTitle: 'Joushen Studio ile panolar, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'İnsanların Joushen Studio ile oluşturduğu panolar',
    galleryLead:
    ...
    faqTitle: 'Pano SSS',
    faq: [
      { q: 'Tableau veya Looker gibi bir BI aracına ihtiyacım var mı?', a: 'Hayır. Joushen Studio panoları kodlama ajanınızın içinde HTML olarak işler. Metrikleri tarif eder ve verinize yönlendirirsiniz; lisanslanacak ya da öğrenilecek ayrı bir BI platformu yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve metriklerinizi her yere barındırabileceğiniz bir panoya dönüştürün — zaten kullandığınız ajanda.',
  },
  slides: {
    title: 'Joushen Studio + Claude Code ile sunum desteleri oluşturun',
    description:
      'Bir taslağı, herhangi bir sunum uygulaması açmadan tasarlanmış, markaya uygun bir slayt destesine dönüştürün. Joushen Studio kodlama ajanınıza deste şablonları ve bir görsel sistem verir, slaytları sunabileceğiniz, dışa aktarabileceğiniz veya paylaşabileceğiniz HTML olarak işler.',
    breadcrumb: 'Slaytlar',
    label: 'Kullanım örneği · Slaytlar',
    heading: 'Tasarlanmış görünen desteler, bir komutla yazılır',
    lead: 'Ajanınıza bir taslak ve bir ton verin. Joushen Studio bir deste şablonu ve görsel sistem uygular, böylece her slayt yerleştirilir, dizilir ve markaya uygundur — boş bir arka plandaki madde listesi değil.',
    heroImageAlt:
      'Soldaki bir taslağın sağda bir dizi tasarlanmış sunum slaytına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio bir taslağı ajanınızın tek bir oturumda işlediği tasarlanmış bir HTML destesine dönüştürür — tarayıcıda sunun, PDF veya PPTX olarak dışa aktarın ve kaynağı deponuzda tutun.',
    stepsTitle: 'Joushen Studio ile desteler nasıl çalışır',
    steps: [
    ...
    tableTitle: 'Joushen Studio ile desteler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'İnsanların Joushen Studio ile oluşturduğu desteler',
    galleryLead:
    ...
    faq: [
      { q: 'PowerPoint ya da Keynote’a ihtiyacım var mı?', a: 'Hayır. Joushen Studio desteleri kodlama ajanınızın içinde HTML olarak işler ve PDF veya PPTX olarak dışa aktarabilir. Tarayıcıdan sunarsınız ya da bir dosya teslim edersiniz — kurmak için herhangi bir sunum uygulaması gerekmez.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve taslağınızı tasarlanmış bir desteye dönüştürün — zaten kullandığınız ajanda.',
  },
  image: {
    title: 'Joushen Studio + Claude Code ile markaya uygun grafikler oluşturun',
    description:
    ...
    lead: 'İhtiyacınız olan kartı ya da kapağı tarif edin. Joushen Studio onu gerçek yazı, ızgara ve marka renklerinizle düzenler — sonra bir tasarım uygulamasıyla ya da genel bir şablonla boğuşmak yerine, görsel olarak dışa aktarabileceğiniz HTML olarak işler.',
    heroImageAlt:
      'Bir komutun bir dizi yerleştirilmiş sosyal kart ve makale kapağına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio bir komutu, ajanınızın HTML olarak işleyip PNG’ye dışa aktardığı dizilmiş, markaya uygun bir grafiğe dönüştürür — yinelenebilir, sürümlenebilir ve koltuk başı tasarım araçlarından arınmış.',
    stepsTitle: 'Joushen Studio ile grafikler nasıl çalışır',
    steps: [
      ...
      { title: 'Marka sistemini uygulayın', body: 'Joushen Studio renklerinizi, yazınızı ve boşluklarınızı yeniden kullanılabilir bir tasarım sisteminden çeker, böylece her kart tek seferlik görünmek yerine markanızın geri kalanıyla eşleşir.', imageAlt: 'Marka renkleri ve yazının bir kart düzenine uygulandığını gösteren illüstrasyon' },
    ...
    tableTitle: 'Joushen Studio ile grafikler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'İnsanların Joushen Studio ile oluşturduğu grafikler',
    galleryLead:
    ...
    faqTitle: 'Görsel SSS',
    faq: [
      { q: 'Bu, Midjourney gibi bir yapay zekâ görsel üreticisi mi?', a: 'Hayır. Joushen Studio grafikleri gerçek düzen ve tipografiyle düzenler — başlığınız, markanız, tam boyutlar — ve PNG olarak dışa aktardığınız HTML olarak işler. Bu, piksel üretimi değil, tasarım düzenlemesidir.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve bir komutu markaya uygun bir grafiğe dönüştürün — zaten kullandığınız ajanda.',
  },
  video: {
    title: 'Joushen Studio + Claude Code ile hareketli grafikler ve kısa video oluşturun',
    description:
    ...
    lead: 'İstediğiniz anı tarif edin — bir başlık açılışı, bir veri animasyonu, bir logo kapanışı. Joushen Studio hareketli kareleri marka sisteminizle düzenler ve videoya işler, hareketli grafik paketi gerekmez.',
    heroImageAlt:
      'Bir senaryonun bir dizi hareketli video karesine dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio bir senaryoyu, ajanınızın kısa biçimli videoya işlediği hareketli, markaya uygun karelere dönüştürür — HTML’den düzenlenir, deponuzda sürümlenir, öğrenilecek bir zaman çizelgesi düzenleyicisi olmadan.',
    stepsTitle: 'Joushen Studio ile hareket nasıl çalışır',
    steps: [
    ...
    tableTitle: 'Joushen Studio ile hareket, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'İnsanların Joushen Studio ile oluşturduğu hareket',
    galleryLead:
    ...
    faqTitle: 'Video SSS',
    faq: [
      { q: 'After Effects ya da bir hareketli grafik paketine ihtiyacım var mı?', a: 'Hayır. Joushen Studio hareketli kareleri HTML’de düzenler ve kodlama ajanınızın içinde videoya işler. Öğrenilecek ya da lisanslanacak bir zaman çizelgesi düzenleyicisi yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve bir senaryoyu harekete dönüştürün — zaten kullandığınız ajanda.',
  },
  designSystem: {
    title: 'Joushen Studio + Claude Code ile bir tasarım sistemi kurun ve uygulayın',
    description:
    ...
    lead: 'Markanızı bir kez tanımlayın, Joushen Studio onu her çıktıya taşısın — prototipler, desteler, panolar, grafikler. Sistem, deponuzda ajanın okuduğu bir DESIGN.md olarak yaşar, böylece tutarlılık elle değil, otomatiktir.',
    heroImageAlt:
      'Tek bir tasarım sisteminin markaya uygun birçok çıktıya ışıdığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio markanızı, ajanınızın her çıktıya uyguladığı taşınabilir bir tasarım sistemi olarak yakalar — deponuzda bir kez tanımlanır, her yerde uygulanır, onu denetleyen merkezi bir tasarım aracı olmadan.',
    stepsTitle: 'Joushen Studio ile tasarım sistemleri nasıl çalışır',
    steps: [
      { title: 'Sistemi yakalayın', body: 'Markanızı tarif edin — renkler, yazı, boşluk, ses — ya da çıkarması için ajanı mevcut bir siteye yönlendirin. Joushen Studio bunu projenizde yaşayan bir DESIGN.md içine yazar.', imageAlt: 'Bir markanın tek bir tasarım sistemi dosyasına yakalandığını gösteren illüstrasyon' },
      { title: 'Kanıtlanmış bir temelden başlayın', body: 'Joushen Studio 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste. Boş bir sayfadan başlamak yerine markanıza yakın olan birini çatallayın.', imageAlt: 'Bir referans tasarım sistemleri galerisinin gezildiğini gösteren illüstrasyon' },
    ...
    tableTitle: 'Joushen Studio ile tasarım sistemleri, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'Joushen Studio’daki tasarım sistemleri',
    galleryLead:
    ...
    faq: [
      { q: 'Buradaki tasarım sistemi tam olarak nedir?', a: 'Deponuzda renkleri, yazıyı, boşluğu, bileşenleri ve sesi yakalayan bir DESIGN.md dosyası. Her Joushen Studio becerisi onu okur, böylece markanız ajanın ürettiği her şeye otomatik olarak uygulanır.' },
      { q: 'Sıfırdan başlamak zorunda mıyım?', a: 'Hayır. Joushen Studio çatallayabileceğiniz 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste — sonra markanıza uyarlarsınız.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve ajanınıza her yerde uygulayacağı tek bir marka verin — zaten kullandığınız ajanda.',
  },
  roleSoloBuilder: {
    title: 'Tek kişilik geliştiriciler ve bağımsız hackerlar için Joushen Studio',
    description:
      'Tek kişilik bir ekip gibi ürün çıkarın. Joushen Studio, kodlama agent’ınızı girişiminizin tasarım yarısına dönüştürür — prototipler, açılış sayfaları, panolar ve marka görselleri, hepsi tek bir komutla, hepsi markaya uygun, hepsi deponuzda.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, tek kişilik bir kurucunun hiç sahip olmadığı tasarım departmanıdır: ürününüzün ihtiyaç duyduğu her yüzeyde komuttan ürüne, tek bir markayla, sıfır devir teslimle ve ek araç olmadan.',
    stepsTitle: 'Tek kişilik bir geliştirici Joushen Studio’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Joushen Studio ile tek başına inşa etmek vs. zor yoldan yapmak',
    ...
    galleryTitle: 'Joushen Studio ile tek başına inşa edildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve tek bir agent’ın tasarım ekibiniz olmasına izin verin — zaten kullandığınız agent’ta.',
  },
  roleDesigner: {
    title: 'Tasarımcılar için Joushen Studio',
    description:
      'Zamanınızı zahmete değil, zevke harcayın. Joushen Studio, agent’ınızın tekrar eden üretim işini — varyantlar, durumlar, tam tasarım sistemleri — üstlenmesini sağlar; siz görünümü yönetir ve son sözü söylersiniz.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, hiç yorulmayan üretim asistanıdır: tasarım sistemini siz tanımlar ve zevki siz belirlersiniz; agent gerisini üretir, sisteme uygun, deponuzun içinde.',
    stepsTitle: 'Bir tasarımcı Joushen Studio’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Joushen Studio ile tasarlamak vs. el yordamı',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'Joushen Studio ile yönetildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve siz zevki belirlerken üretimi agent yapsın — zaten kullandığınız agent’ta.',
  },
  roleEngineering: {
    title: 'Mühendisler için Joushen Studio',
    description:
      'Tasarım devir teslimini atlayın. Joushen Studio, bir DESIGN.md’yi kodlama agent’ınızın doğrudan yazdığı gerçek bir ön uca dönüştürür — sisteme uygun arayüz, prototipler ve panolar, depoda, Figma gidiş dönüşü olmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, tasarım sistemini makine tarafından okunabilir kılarak tasarımcı-mühendis boşluğunu kapatır: kodunuzu yazan aynı agent sistemi uygular ve gerçek arayüzü işler.',
    stepsTitle: 'Bir mühendis Joushen Studio’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Joushen Studio ile ön uç vs. devir teslim yolu',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'Mühendisler tarafında Joushen Studio ile inşa edildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve bir DESIGN.md’yi ön uca dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleProductManagers: {
    title: 'Ürün yöneticileri için Joushen Studio',
    description:
      'Bir fikri iletmek için tasarım kapasitesini beklemeyi bırakın. Joushen Studio, bir ürün yöneticisinin bir komutu tıklanabilir bir prototipe ya da tel çerçeveye dönüştürmesini sağlar — paydaşları hizalamak ve ekibi bilgilendirmek için, tasarım talebi açmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, bir ürün yöneticisine fikirleri somutlaştırmanın tasarımsız bir yolunu sunar: hizalama ve bilgilendirme için komuttan prototipe, ekibin tasarım bütçesini harcamadan.',
    stepsTitle: 'Bir ürün yöneticisi Joushen Studio’ı nasıl kullanır',
    steps: [
      {
        title: 'Akışı anlatın',
    ...
    tableTitle: 'Joushen Studio ile ürün yöneticiliği vs. tasarımı beklemek',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Joushen Studio ile',
    ...
    galleryTitle: 'Ürün yöneticileri tarafında Joushen Studio ile prototiplendi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve bir sonraki spesifikasyonunuzu insanların tıklayabileceği bir şeye dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleMarketing: {
    title: 'Pazarlama ekipleri için Joushen Studio',
    description:
      'Kampanyaları içerik hızında çıkarın. Joushen Studio, agent’ınızın bir komuttan açılış sayfaları, sosyal kartlar ve kampanya görselleri üretmesini sağlar — markaya uygun, talep üzerine, tasarım kuyruğuna girmeden.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Joushen Studio, pazarlama için her zaman açık tasarım kaynağıdır: açılış sayfaları ve sosyal için komuttan içeriğe, markaya uygun, böylece kampanyalar metin yazdığınız hızda yayına alınır.',
    stepsTitle: 'Bir pazarlama ekibi Joushen Studio’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Joushen Studio ile pazarlama vs. her zamanki telaş',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Joushen Studio ile',
    tableColWithout: 'Bugün onsuz',
    tableRows: [
    ...
    galleryTitle: 'Pazarlama tarafında Joushen Studio ile yayına alındı',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Joushen Studio’ı kurun ve brief’leri markaya uygun içeriklere dönüştürün — zaten kullandığınız agent’ta.',
  },
};
