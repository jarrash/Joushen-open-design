...
- Consume `@joushen-studio/sidecar-proto`, `@joushen-studio/sidecar`, and `@joushen-studio/platform` primitives; do not hand-build stamp flags or process matching logic.
