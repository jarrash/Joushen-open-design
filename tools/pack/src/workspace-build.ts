...
const BUILD_COMMANDS = [
  { args: ["--filter", "@joushen-studio/components", "build"] },
  { args: ["--filter", "@joushen-studio/contracts", "build"] },
  { args: ["--filter", "@joushen-studio/registry-protocol", "build"] },
  { args: ["--filter", "@joushen-studio/sidecar-proto", "build"] },
  { args: ["--filter", "@joushen-studio/launcher-proto", "build"] },
  { args: ["--filter", "@joushen-studio/sidecar", "build"] },
  { args: ["--filter", "@joushen-studio/platform", "build"] },
  { args: ["--filter", "@joushen-studio/download", "build"] },
  { args: ["--filter", "@joushen-studio/host", "build"] },
  { args: ["--filter", "@joushen-studio/agui-adapter", "build"] },
  { args: ["--filter", "@joushen-studio/plugin-runtime", "build"] },
  { args: ["--filter", "@joushen-studio/diagnostics", "build"] },
  { args: ["--filter", "@joushen-studio/daemon", "build"] },
  { args: ["--filter", "@joushen-studio/web", "build"], env: ["OD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@joushen-studio/web", "build:sidecar"] },
  { args: ["--filter", "@joushen-studio/desktop", "build"] },
  { args: ["--filter", "@joushen-studio/packaged", "build"] },
] as const;
