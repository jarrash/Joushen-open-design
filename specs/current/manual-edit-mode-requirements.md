# Joushen Studio Manual Edit Mode Requirements

## Purpose

This document records the accepted manual edit-mode model from `apps/edit-mode-demo` so it can be migrated into the main Joushen Studio web app.
...
- Preserve Joushen Studio's existing preview model.
...
- Joushen Studio-specific mode rail:
  - Preview
  - Edit
  - Comment AI
  - Tweaks
...
Existing Joushen Studio integration points:
