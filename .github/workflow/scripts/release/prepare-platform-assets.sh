...
case "$RELEASE_TARGET" in
  mac_arm64 | mac_x64)
    ...
    source_dmg="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/dmg/Joushen Studio-$RELEASE_NAMESPACE.dmg"
    source_zip="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/zip/Joushen Studio-$RELEASE_NAMESPACE.zip"
    source_payload="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/payload/Joushen Studio-$RELEASE_NAMESPACE-payload.zip"
    ...
    release_notes="${RELEASE_NOTES:-Joushen Studio $RELEASE_VERSION$RELEASE_ASSET_SUFFIX}"
...
EOF
    ;;
  linux_x64)
    source_appimage="$TOOLS_PACK_DIR/out/linux/namespaces/$RELEASE_NAMESPACE/builder/Joushen Studio-$RELEASE_NAMESPACE.AppImage"
