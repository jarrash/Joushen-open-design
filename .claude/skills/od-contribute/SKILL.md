...
# od-contribute — first-contribution flow for Joushen Studio
...
- The user wants to *generate* a Skill / Design System from scratch → that's Joushen Studio itself. Run OD first, get an artifact, then come back here to ship it.
