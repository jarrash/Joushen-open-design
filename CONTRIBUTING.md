# Contributing to Joushen Studio
...
pnpm --filter @joushen-studio/web build  # web package build when needed
```
...
Run Joushen Studio without installing Node.js or pnpm.
