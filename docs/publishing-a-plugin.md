# Publishing A Joushen Studio Plugin

Joushen Studio registry publishing is GitHub-backed in v1. The CLI remains the
...
The generated `open-design.json` is the Joushen Studio sidecar next to `SKILL.md`.
...
These commands wrap GitHub CLI. Tokens stay in `gh`; Joushen Studio does not store
GitHub credentials.
