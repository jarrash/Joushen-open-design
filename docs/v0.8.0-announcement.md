# 🔥 Joushen Studio 0.8.0-preview — Design's old world ends here. Help us build the new one.
...
→ [**Join the Joushen Studio preview Discord**](https://discord.gg/RchHB7DQS)
