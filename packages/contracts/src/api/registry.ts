...
export type AgentFixIntent =
  ...
  | { kind: 'rescan' }
  /**
   * Prompt the user to point Joushen Studio at an explicit binary by writing
...
export interface AgentInfo {
  ...
  /** Whether models came from the installed CLI or Joushen Studio's static fallback. */
