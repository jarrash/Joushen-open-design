...
describe('@joushen-studio/contracts package runtime shape', () => {
  ...
  it('makes runtime exports importable through package exports', async () => {
    const contracts = await import('@joushen-studio/contracts');
    const connectionTest = await import('@joushen-studio/contracts/api/connectionTest');
    const research = await import('@joushen-studio/contracts/api/research');
    const handoff = await import('@joushen-studio/contracts/api/handoff');
    const critique = await import('@joushen-studio/contracts/critique');
